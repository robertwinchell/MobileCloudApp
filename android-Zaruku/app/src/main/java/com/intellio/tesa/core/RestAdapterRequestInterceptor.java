...
import static com.intellio.tesa.core.Constants.Http.HEADER_PARSE_APP_ID;
import static com.intellio.tesa.core.Constants.Http.HEADER_PARSE_REST_API_KEY;
import static com.intellio.tesa.core.Constants.Http.PARSE_APP_ID;
import static com.intellio.tesa.core.Constants.Http.PARSE_REST_API_KEY;
...
public class RestAdapterRequestInterceptor implements RequestInterceptor {
    ...
    public void intercept(RequestFacade request) {
        ...
        request.addHeader("Authorization","Basic ZGV2OmRldmlscGFzcw==");
