package com.intellio.tesa.authenticator;
...
import com.intellio.tesa.R.id;
import com.intellio.tesa.R.layout;
import com.intellio.tesa.R.string;
import com.intellio.tesa.core.TesaService;
import com.intellio.tesa.core.Constants;
import com.intellio.tesa.core.User;
import com.intellio.tesa.events.UnAuthorizedErrorEvent;
import com.intellio.tesa.ui.TextWatcherAdapter;
import com.intellio.tesa.util.Ln;
...
public class AuthenticatorActivity extends ActionBarAccountAuthenticatorActivity {
    ...
    public void onCreate(Bundle bundle) {
        ...
        final TextView forgetPwdText= Views.findById(this,id.tv_forgetpwd);
        forgetPwdText.setMovementMethod(LinkMovementMethod.getInstance());
        forgetPwdText.setText(Html.fromHtml(getString(string.forget_password_link)));
    }
    ...
    public void onUnAuthorizedErrorEvent(UnAuthorizedErrorEvent unAuthorizedErrorEvent) {
        ...
        Toaster.showLong(AuthenticatorActivity.this, R.string.message_bad_credentials);
    }
    ...
    public void handleLogin(final View view) {
        ...
        authenticationTask = new SafeAsyncTask<Boolean>() {
            public Boolean call() throws Exception {
                ...
                User loginResponse = tesaService.authenticate(email, password);
