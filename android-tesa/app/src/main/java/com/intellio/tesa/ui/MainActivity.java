...
import com.intellio.tesa.events.NavItemSelectedEvent;
import com.intellio.tesa.util.Ln;
import com.intellio.tesa.util.SafeAsyncTask;
import com.intellio.tesa.util.UIUtils;
 ...
 * {@link com.intellio.tesa.authenticator.ApiKeyProvider#getAuthKey(android.app.Activity)}
 */
public class MainActivity extends BaseFragmentActivity {
    ...
    private void checkAuth() {
        new SafeAsyncTask<Boolean>() {
            ...
            public Boolean call() throws Exception {
                final TesaService svc = serviceProvider.getService(MainActivity.this);
                return svc != null;
            }
    ...
    private void navigateToTimer() {
       ...
       // Intent i=new Intent(this,Picture_Selection.class);
     //   startActivity(i);
    }
