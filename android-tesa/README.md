...
[![Build Status](https://travis-ci.org/AndroidBootstrap/com-intellio-tesa.svg?branch=master)](https://travis-ci.org/AndroidBootstrap/com-intellio-tesa)

This repository contains the source code for the [Tesa](http://www.androidbootstrap.com/)
Android app available from [Google Play](https://play.google.com/store/apps/details?id=com.intellio.tesa).

Please see the [issues](https://github.com.intellio.tesa/com-intellio-tesa/issues) section
to report any bugs or feature requests and to see the list of known issues.

Have a questions about Tesa? Ask away on the [com-intellio-tesa discussion forum](https://groups.google.com/forum/#!forum/com-intellio-tesa).

<a href="https://play.google.com/store/apps/details?id=com.intellio.tesa" alt="Download from Google Play">
...
code for the app will change:
  ...
  - From: __com.intellio.tesa__
  - To: __com/notify/app/mobile__

At that point all the source files that were located in ____com.intellio.tesa__ will be moved to the
new folder __com/notify/app/mobile__.

All import statments that reference the old resources (__R.com.intellio.tesa.R__) will now be renamed
...
signed with a different key.  Manually uninstall Tesa from your device and
...
Tesa is a result of a template project I've developed over the years as well as
...
Tesa is built on the awesome [Parse.com API](http://www.parse.com/)
...
## Contributors
Thank you to all the [contributors](http://www.github.com.intellio.tesa/com-intellio-tesa/contributors) on
...
[pull requests](https://github.com.intellio.tesa/com-intellio-tesa/pulls).
